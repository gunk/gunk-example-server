module github.com/gunk/gunk-example-server
...
require (
	...
	github.com/chromedp/omahaproxy v0.1.5 // indirect
	...
	github.com/kenshaw/diskcache v0.6.4 // indirect
